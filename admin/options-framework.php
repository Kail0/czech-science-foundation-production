...
function optionsframework_add_page() {
	...
	$of_page = add_menu_page('Theme Options', 'GACR Options', 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_page() {
    ...
    <div id="of_container">
	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          <div class="logo">
            <h2><?php esc_html_e( '-_-' ); ?> <?php esc_html_e( 'Options' ); ?></h2>
          </div>

          <div class="kailoauthor">
            <h2><a href="http://kailo.photography"><?php esc_attr_e( 'A Theme by','kailoframework' ); ?> <strong><?php esc_attr_e( 'Kailo in cooperation with Google Material Design guidelines','kailoframework' ); ?></strong></a></h2>
          </div>
        ...
        <div class="of_admin_bar">
			<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options','kailoframework' ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults','kailoframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!','kailoframework' ) ); ?>' );" />
		</div>
<div class="clear"></div>
	</form>
</div> <!-- / #container -->
...
function optionsframework_validate($input) {
	...
	if (!empty($_POST['reset'])) {
		...
		if (delete_option($option_name) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'kailoframework' ), 'updated fade' );
		}
	}
	...
	if ( isset($clean) ) {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'kailoframework' ), 'updated fade' );
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options','kailoframework' ),
