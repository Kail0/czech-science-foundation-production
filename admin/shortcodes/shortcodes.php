<?php
// WORDPRESS CUSTOM SHORTCODES Coded and Designed by WP
// http://wpthemess.com
// Licence: Free / GPL
...
function scd_wide_slider_gallery($atts, $content) {
    ...
    $shortcode.= '<div class="kailo_post_slider_wide"><div id="wide_post_gallery_'.$id.'">';
        $args = array(
...
extract(shortcode_atts(array(
    ...
    'border' => '1px',
    'bordertype' => 'solid',
    'from' => 'Anthony, kailo.photography',
    'link' => 'http://kailo.photography/',
    'linkcolor' => '#000000'
  ), $atts));
...
//USAGE:[donate text="Make a donation" account="info@yourwebsite.com" for="Kailo Wordpress Theme"] [/donate]
